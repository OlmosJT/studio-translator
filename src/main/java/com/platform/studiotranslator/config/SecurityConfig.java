...
import com.platform.studiotranslator.config.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    // CORS Configuration to allow Nuxt (localhost:3000) to talk to Spring (localhost:8080)
    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        CorsConfiguration configuration = new CorsConfiguration();
        configuration.setAllowedOrigins(List.of("http://localhost:3000")); // Your Nuxt URL
